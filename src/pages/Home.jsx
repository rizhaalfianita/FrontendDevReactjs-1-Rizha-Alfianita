...
export const Home = () => {
  ...
  return (
    <div className="mx-auto w-10/12 p-10 min-h-screen overflow-y-auto scroll-smooth font-poppins text-softBlack">
      ...
      <p className="text-base mb-6 text-gray text-justify">
      ...
      <div className="flex justify-between text-sm items-center pr-10 max-sm:flex-wrap max-sm:mb-6 max-sm:justify-center">
        <div className="flex gap-x-4 my-6 max-sm:flex-wrap max-sm:gap-y-3 max-sm:justify-center">
          <p className="text-gray max-sm:text-base">Filter By:</p>
          <CustomRadioButton
            label="Open Now"
        ...
        <button
          ...
          } bg-white border-1 h-fit px-8 py-1 max-sm:text-base`}
      ...
      <div className="py-10">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-4 gap-x-4 gap-y-6 mb-14 max-sm:grid-cols-1">
            {showOpenNow || selectedCategory !== "" || selectedPrice !== ""
        ...
        <div className="flex justify-center">
          {showOpenNow || selectedCategory !== "" || selectedPrice !== "" ? (
            ...
            visibleCount < restaurants.length && (
              <button
                className="border-1 border-darkerSky bg-white py-2.5 w-1/4 text-darkerSky text-sm transition-all hover:translate-y-2 max-sm:w-full"
